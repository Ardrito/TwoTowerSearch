...
# Load validation triples
with open("saved_artifacts/triples_validation.json", encoding="utf-8") as f:
    triples = json.load(f)
...
print("🔄 Generating validation average embeddings...")
for batch in loader:
...
# Save embeddings
np.save("saved_artifacts/query_embeddings_validation.npy", query_embeddings)
np.save("saved_artifacts/doc_embeddings_validation.npy", doc_embeddings)

with open("saved_artifacts/raw_queries_validation.json", "w", encoding="utf-8") as f:
    json.dump(raw_queries, f, indent=2, ensure_ascii=False)

with open("saved_artifacts/raw_docs_validation.json", "w", encoding="utf-8") as f:
